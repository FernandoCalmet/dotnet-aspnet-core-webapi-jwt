using JWT.Authentication.WebAPI.Constants;
using JWT.Authentication.WebAPI.Contexts;
...
namespace JWT.Authentication.WebAPI.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IOptions<Settings.JWT> jwt, ApplicationDbContext context)
        {
            _context = context;
